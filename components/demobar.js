  ...
  render() {
    ...
    return (
     ...
     {/*   <h4 className="float-left">Preview</h4> */}
        ...
        <button  variant="contained" color="secondary" style={{ marginRight: '20px' }} >Copy the Link of the formular</button>

        <Link href="/result" >
  <button variant="contained" color="secondary">Show Answers</button>
</Link>
